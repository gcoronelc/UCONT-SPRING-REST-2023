...
BEGIN
	COMMAND := 'DROP USER eureka2023 CASCADE';
	SELECT COUNT(*) INTO N
	FROM DBA_USERS
	WHERE USERNAME = 'EUREKA2023';
	IF ( N = 1 ) THEN
...
CREATE USER EUREKA2023 IDENTIFIED BY admin;

GRANT CONNECT, RESOURCE TO EUREKA2023;

ALTER USER EUREKA2023
QUOTA UNLIMITED ON USERS;

GRANT CREATE VIEW TO EUREKA2023;
